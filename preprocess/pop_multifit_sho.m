% pop_multifit_sho() - fit multiple component dipoles using DIPFIT 
%
% Modified by Sho Nakagome:
%   When individual headmodel is given, it was replaced the template file
%   in "EEG = eeg_checkset(EEG, 'chanlocs_homogeneous');" (this line)
%   so in this custom code, I disabled it.
%
% Usage:
...
function [EEG, com] = pop_multifit_sho(EEG, comps, varargin);
